...
const Navbar = ({route,scrollRef}) => {
    const navigation = useNavigation();
    return(
        <View style = {styles.navWrap}>
            <TouchableOpacity onPress={() => {route.name == "Home" ? scrollRef.current.scrollTo({y:0,animation:true}):navigation.navigate('Home')}} style={route.name == "Home" ? styles.buttonSelected : styles.button} title="home"><Image style={styles.img} source={route.name == "Home" ? require("../assets/home-1.png") : require("../assets/home-2.png")}/></TouchableOpacity>

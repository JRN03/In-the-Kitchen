...
export default function AddFriendDialogue({visible,onClose}){
    ...
    const addFriend = async () => {
      console.log("Adding friend AddFriendDialogue 13");
        ...
        >
          <View style={styles.modalContainer}>
            <View style={styles.popupContainer}>
              ...
              <Searchbar text={text} placeholder={"Add Friend by Username"} onChange={setText}/>
              <View style={styles.buttons}>
                <TouchableOpacity style={styles.button} onPress={() => {onClose();setText("");}}><Text style={styles.close}>Cancel</Text></TouchableOpacity>
                <TouchableOpacity style={styles.button} onPress={() => {addFriend();onClose();}}><Text style={styles.add}>Add</Text></TouchableOpacity>
              </View>
            </View>
          </View>
        </Modal>
